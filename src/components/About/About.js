        ...
        <Fade duration={500}>
          <div className="container my-5">
            <Alert variant="success">
              ...
              <h4 className="text-center">
                DSA TRACKER helps you build your confidence in solving any
          ...
          <div className="container my-5">
            <h2 className="text-center">
              <a href="https://www.dsatracker.com">450dsa</a> is your personal
            ...
            <h4 className="text-center my-5">
              Project by{" "}
              <a
                href="https://www.linkedin.com/in/tarak-sai-ruthwik-purimetla-447a6b288/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Ruthwik
